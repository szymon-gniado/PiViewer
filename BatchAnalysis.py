...
if __name__ == '__main__':
    ...
    if False:   # test if single pdb works
        ...
        lig_name = 'THA'
        print(PiViewer.find_PiPi(pdb_file, lig_name, 5.0, 25, 80, 0))
    ...
    with open(pdb_list_file, 'r') as fin:
        os.chdir('/home/blendzior/PiViewer/Dataset/Iridium_HT_deposited')
        ...
        for line in fin:
            ...
            for lig_name in lig_list:
                count = PiViewer.find_PiPi(pdb_file, lig_name, verbose=0)
                if count > 0:
                    total_found += count
                elif count == -1:
                    total_unfound += 1
